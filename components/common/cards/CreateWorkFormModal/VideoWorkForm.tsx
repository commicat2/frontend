...
const VideoWorkForm = ({ setFormData, isHidden }: { setFormData: SetState<CreateWorkRequest>, isHidden: boolean }) => {
  ...
  const updateTextSample = (value: string) => { setFormData((prev) => { return { ...prev, text_sample: value } }) }
