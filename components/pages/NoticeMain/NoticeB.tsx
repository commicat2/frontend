  ...
  return (
    <MainContainer>
      <div className={styles.content}>
        ...
        <p className={styles.comment}>&emsp;- 아이디: 본인의 프로필 페이지의 주소에 사용되는 식별자입니다.</p>
        <p className={styles.comment}>&emsp;- 닉네임: 외부에 노출되는 회원님의 별칭입니다.</p>
        <p className={styles.comment}>&emsp;- 사진: 외부에 노출되는 회원님의 프로필 이미지입니다.</p>
        <p className={styles.comment}>&emsp;- 배경: 본인의 프로필 페이지 상단에 노출되는 배경 이미지입니다.</p>
        <p className={styles.comment}>&emsp;- 소개: 본인의 프로필 페이지에 노출되는 자기소개입니다.</p>
        <p className={styles.comment}>&emsp;&emsp;* 소개란에 본인이 작업할 수 있는 유형이나 가격 등을 명시해도 됩니다.</p>
        <p className={styles.comment}>&emsp;- X 링크: 본인의 X(트위터) 링크입니다.</p>
        ...
        <p className={styles.comment}>&emsp;&emsp;* 인증하기 전, 대부분의 서비스를 이용할 수 없습니다.</p>
        ...
        <p className={styles.comment}>&emsp;d. 계좌 정보는 크리에이터로서 작업 대금 지급, 또는 클라이언트로서 입금 및 환불 처리에 이용됩니다.</p>
        <br />
        ...
        <p className={styles.comment}>&emsp;a. 프로필에 등록한 X계정의 자기소개에 본인의 프로필 페이지 링크를 적고 체크하시면 5%의 수수료로 이용하실 수 있습니다.</p>
        <p className={styles.comment}>&emsp;&emsp;* 허위기재시 수수료 혜택을 받지 못하실 수 있습니다.</p>
        <p className={styles.comment}>&emsp;&emsp;* 수수료 혜택 없이도 서비스를 이용하실 수 있습니다.</p>
        ...
        <p className={styles.comment}>&emsp;g. 프로필 페이지에 게시되는 자기소개서입니다.</p>
        <p className={styles.comment}>&emsp;&emsp;* 이미지 최대 10장, 유튜브 링크 등을 활용할 수 있습니다.</p>
        <p className={styles.comment}>&emsp;h. 전달할 작업물의 유형입니다.</p>
        <p className={styles.comment}>&emsp;i. 요청 받을 카테고리를 정합니다.</p>
        <p className={styles.comment}>&emsp;j. 작업 요청의 최소 금액을 정합니다.</p>
        <p className={styles.comment}>&emsp;k. 작업 요청의 승인/거절 응답 기한을 정합니다.</p>
        <p className={styles.comment}>&emsp;l. 작업 요청 승인 후 결제가 완료된 시점부터 계산되는 완료 기한입니다.</p>
        <br />
        <p>5. 작업 요청의 상태, 알림, dm 등은 사이트 상단에서 확인할 수 있습니다. 작업 요청이 들어올 경우, b를 눌러 작업 페이지로 이동해주세요.</p>
        <div className={styles.image} style={{ paddingBottom: '46.5%' }}>
          <Image fill sizes="100%" priority src="/guide5.png" alt="Guide 5" />
        </div>
        <p className={styles.comment}>&emsp;a. 작업 요청이 들어오거나 요청의 상태가 변경될 때, 그리고 기타 알림사항이 있을 때 받는 알림 페이지입니다.</p>
        <p className={styles.comment}>&emsp;&emsp;* 계정 설정을 통해 이 알림을 메일로도 받으실 수 있습니다.</p>
        <p className={styles.comment}>&emsp;b. 작업 요청들을 확인할 수 있는 페이지입니다.</p>
        <p className={styles.comment}>&emsp;c. dm을 확인할 수 있는 페이지입니다.</p>
        ...
        <p className={styles.comment}>&emsp;&emsp;* 요청의 내용 역시 공개 유형일 경우 외부에 공개됩니다.</p>
        ...
        <p className={styles.comment}>&emsp;d. 요청의 승인/거절 응답 기한입니다.</p>
        <p className={styles.comment}>&emsp;&emsp;* 응답 기한이 지날 경우, 요청은 자동으로 거절됩니다.</p>
        <p className={styles.comment}>&emsp;&emsp;* 거절 시, 거절 사유를 전달할 수도 있고, 적지 않아도 괜찮습니다.</p>
        <br />
        <p>7. 승인 후 클라이언트의 결제를 기다려주세요.</p>
        <p className={styles.comment}>&emsp;* 결제 기한은 응답한 시점부터 3일 후 까지입니다.</p>
        <p className={styles.comment}>&emsp;* 반복적으로 결제 기한을 넘기는 클라이언트는 서비스 이용제한 될 수 있습니다.</p>
        <br />
        <p>8. 결제처리가 됐을 경우 요청 내용에 맞게 작업 완료 기한 전까지 작업물을 완성해주세요.</p>
        ...
        <p className={styles.comment}>&emsp;* 작업중 상태의 카드를 클릭하면 완료를 위한 양식이 열립니다.</p>
        <div className={styles.image} style={{ paddingBottom: '63%' }}>
          <Image fill sizes="100%" priority src="/guide8.png" alt="Guide 8" />
        </div>
        <p className={styles.comment}>&emsp;a. 요청한 클라이언트에게 전달할 파일들입니다.</p>
        ...
        <p className={styles.comment}>&emsp;e. 코멘트: 작업의 상세 페이지 하단에 게시됩니다.</p>
        <p className={styles.comment}>&emsp;f. 해시 태그: 검색에 이용됩니다.</p>
        <br />
        ...
        <p className={styles.comment}>&emsp;* 비공개 요청이 아니라면 상세페이지의 링크를 확인할 수 있습니다.</p>
        <br />
        <p>10. 상세페이지가 게시됩니다.</p>
        ...
        <div className={styles.image} style={{ paddingBottom: '65%' }}>
          <Image fill sizes="100%" priority src="/guide11.png" alt="Guide 11" />
        </div>
        <p className={styles.comment}>&emsp;a. 이미지를 업로드합니다.(최대 10장)</p>
        <p className={styles.comment}>&emsp;b. 유튜브 링크로 동영상을 업로드합니다.</p>
