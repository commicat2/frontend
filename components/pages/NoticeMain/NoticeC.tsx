  ...
  return (
    <NoticeMainContainer>
      <div className={styles.content}>
        ...
        <div className={styles.image} style={{ paddingBottom: '48%' }}>
        ...
        <p className={styles.comment}>&emsp;i. 클라이언트로서 요청한 작업 목록</p>
        <p className={styles.comment}>&emsp;j. 비공개가 아닌 작업들을 볼 수 있습니다.</p>
        <br />
        <p>5. 요청 내용을 전달해주세요.</p>
        <div className={styles.image} style={{ paddingBottom: '80%' }}>
        ...
        <div className={styles.image} style={{ paddingBottom: '24.5%' }}>
        ...
        <br />
        <p>11. 비공개 요청이 아니라면, 본인의 프로필 페이지의 요청한 작업 목록에 완료된 작업이 추가됩니다.</p>
      </div>
    </NoticeMainContainer>
  )
}
